...
## ❖ Admin panel
This picture displays is of the Admin Panel of the system. It welcomes the admin with a welcome message and provides a button titled "View Orders Table," which likely leads to the page where the admin can view and process customers' orders.
